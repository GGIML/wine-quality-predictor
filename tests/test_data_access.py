...
class DataAccessTests(TestCase):
    ...
    def test_build_train_tests_sets(self):
        ...
        assert(list(train_test_sets.keys()) == ['train', 'test'])
        assert(train_test_sets['train'][0].shape[0] == train_size*df.shape[0])
        assert(train_test_sets['train'][1].shape[0] == train_size*df.shape[0])
